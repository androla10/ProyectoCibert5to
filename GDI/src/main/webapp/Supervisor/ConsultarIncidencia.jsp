...
<div class="container-fluid">
	<s:if test="ResultadoDerivar == 1">
		<div class="alert alert-danger animated zoomIn" id="alertarcodigo"
			role="alert">
			<p>No puede derivar una incidencia que ya está asignado a usted.
			</p>
		</div>
	</s:if>
	...
	<div class="panel-primary">
		...
		<div class="panel-body">
					...
					<div class="input-group">
						<form action="ConsultaIncidenciaPorCodigo">
							<input type="text" class="form-control"
								placeholder="Buscar por código de Incidencia"
								name="idIncidencia"> <span class="input-group-btn">
			...
			<br>
			<s:if test="atencion.idIncidencia != 0">
				<div class="jumbotron animated zoomIn"
					style="background-color: #FFDD83; padding: 10px 10px;">
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
							...
							<div class="form-group">
								<h4>
									Telefono :
									<s:property value="atencion.telefono" />
								</h4>
							</div>
							<div class="form-group">
						...
						<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
							...
							<s:url id="envio" action="../Seguimiento/DetalleSeguimiento">
								<s:param name="idIncidencia" value="%{atencion.idIncidencia}" />
							</s:url>
							<a href="${envio}">Ir a más detalle</a>
						</div>
					</div>
				</div>
			</s:if>
