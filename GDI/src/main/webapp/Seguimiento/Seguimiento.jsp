...
<script type="text/javascript">
	...
	var objeto = function(Obj) {
		var elemento = document.getElementById(Obj.idIncidencia);
		var activo = "#fff";
		var inactivo = "#ccc";
		var bordes = "#ccc";
			...
			<s:iterator value="lSeguimiento">
				<article>
					<div class="col-xs-12 col-sm-3 col-md-4 col-lg-4">
						...
						<s:url id="envio" action="DetalleSeguimiento">
							<s:param name="idIncidencia" value="%{idIncidencia}" />
						</s:url>
						<a href="${envio}">Ir a más detalle</a>
					</div>
					<div class="col-xs-12 col-sm-9 col-md-8 col-lg-8">
						<canvas id="<s:property value="idIncidencia"/>" width="800"
							height="300">
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			var ConsumirServicioSeguimiento = function() {
				var url = "../Seguimiento/ObtenerSeguimiento"
				var data = {};

				$.getJSON(url).done(function(json) {
					console.log(json);
					$.each(json.lSeguimiento, function(key, value) {
						var Canvas = new objeto(value);
						Canvas.cargarCanvas();
					});
