	...
	var objeto = function(id) {
		...
		this.cargarCanvas = function() {
			if (elemento.getContext("2d")) {
				...
				lienzo.arc(100, 100, 50, 0, Math.PI * 2, true);
				...
				lienzo.beginPath();
				lienzo.fillStyle = fillactive;
				lienzo.arc(300, 100, 50, 0, Math.PI * 2, true);
				...
				lienzo.beginPath();
				lienzo.fillStyle = fillactive;
				lienzo.arc(500, 100, 50, 0, Math.PI * 2, true);
				...
				lienzo.beginPath();
				lienzo.fillStyle = fillactive;
				lienzo.arc(700, 100, 50, 0, Math.PI * 2, true);
				lienzo.closePath();
				lienzo.stroke();
